...
logging.basicConfig(level=logging.INFO, filename='etl4_evaluation.log', filemode='w')

STUDENT_ID = os.environ.get('STUDENT_ID')
BQ_DATASET = 'health_shared'
BQ_TABLE = 'vitals_raw'
SPANNER_INSTANCE = 'health-shared-instance'
SPANNER_DATABASE = 'health_shared_db'
SPANNER_TABLE = f'vitals_summary_{STUDENT_ID}'
...
def check_spanner_schema():
    ...
    with database.snapshot() as snapshot:
        ...
        expected = {('patient_id', 'STRING'), ('vital_date', 'DATE'), ('avg_heart_rate', 'FLOAT64'), ('avg_bp', 'STRING')}
