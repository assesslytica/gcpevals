...
logging.basicConfig(level=logging.INFO, filename='etl2_evaluation.log', filemode='w')

STUDENT_ID = os.environ.get('STUDENT_ID')
BQ_DATASET = 'iot_shared'
BQ_TABLE = 'sensor_raw'
SPANNER_INSTANCE = 'iot-shared-instance'
SPANNER_DATABASE = 'iot_shared_db'
SPANNER_TABLE = f'sensor_summary_{STUDENT_ID}'
...
def check_spanner_schema():
    ...
    with database.snapshot() as snapshot:
        ...
        expected = {('sensor_id', 'STRING'), ('reading_date', 'DATE'), ('avg_temp', 'FLOAT64'), ('avg_humidity', 'FLOAT64')}
